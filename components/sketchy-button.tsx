...
export function SketchyButton({
  ...
  const baseStyles = cn(
    "relative inline-flex items-center justify-center px-8 py-4 text-base font-semibold tracking-wide transition-all duration-300 ease-out motion-safe:hover:-translate-y-0.5 motion-safe:hover:shadow-lg motion-safe:active:translate-y-0 focus:outline-none focus:ring-2 focus:ring-offset-2",
